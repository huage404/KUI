...
describe('Collapse', () => {
    ...
    it('接受 selected 属性', (done) => {
        ...
        div.innerHTML = `
        <k-collapse :selected="xxx">
          <k-collapse-item title="标题1" name="1"><span id="content-1">1</span></k-collapse-item>
          <k-collapse-item title="标题2" name="2"><span id="content-2">2</span></k-collapse-item>
          <k-collapse-item title="标题3" name="3"><span id="content-3">3</span></k-collapse-item>
        </k-collapse>
    `
        const vm = new Vue({
            el: div,
    ...
    it('接受 single 属性', (done) => {
        ...
        document.body.appendChild(div)
        div.innerHTML = `
        <k-collapse :selected.sync="xxx" single>
          <k-collapse-item title="标题1" name="1"><span id="content-1">1</span></k-collapse-item>
          <k-collapse-item title="标题2" name="2"><span id="content-2">2</span></k-collapse-item>
          <k-collapse-item title="标题3" name="3"><span id="content-3">3</span></k-collapse-item>
        </k-collapse>
    ...
    it('触发 update:selected 事件', (done) => {
        ...
        document.body.appendChild(div)
        div.innerHTML = `
        <k-collapse :selected="xxx" @update:selected="onSelect">
          <k-collapse-item title="标题1" name="1"><span id="content-1">1</span></k-collapse-item>
          <k-collapse-item title="标题2" name="2"><span id="content-2">2</span></k-collapse-item>
          <k-collapse-item title="标题3" name="3"><span id="content-3">3</span></k-collapse-item>
        </k-collapse>
